...
import { AlertCircle, ArrowLeft, Eye, EyeOff, Leaf, Lock } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        <div className="mb-8 flex items-center justify-center gap-3">
          ...
          <div>
            ...
            <div className="text-xs uppercase tracking-[0.22em] text-emerald-600">Password Baru</div>
          </div>
        </div>
        ...
        <Card className="overflow-hidden rounded-[28px] border-emerald-100/80 bg-white/95 shadow-[0_24px_80px_-32px_rgba(16,185,129,0.55)]">
          ...
          <CardHeader className="space-y-2 pb-4">
            <CardTitle className="text-3xl text-slate-900">Atur Password Baru</CardTitle>
            <CardDescription>
              Masukkan password baru untuk akun nasabah Anda. Tautan reset hanya berlaku dalam waktu terbatas.
            </CardDescription>
          </CardHeader>
          <CardContent>
