        ...
        <Card className="overflow-hidden rounded-[28px] border-emerald-100/80 bg-white/95 shadow-[0_24px_80px_-32px_rgba(16,185,129,0.55)]">
          ...
          <CardHeader className="space-y-3 pb-4">
            <div className="flex items-center justify-between text-xs font-semibold uppercase tracking-[0.2em] text-emerald-600">
              <span>Sign In</span>
              <Badge variant="outline" className="rounded-lg border-emerald-100 bg-emerald-50 text-emerald-700 font-bold px-2 py-0">{role === 'admin' ? 'Admin' : 'Nasabah'}</Badge>
            </div>
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-2 gap-3 rounded-2xl bg-emerald-50 p-3 text-sm text-emerald-900">
              <div className="rounded-2xl bg-white/80 p-3 shadow-sm border border-emerald-100/50">
                ...
                <div className="mt-1 text-xs text-emerald-700 leading-tight">Setor sampah, cek poin, dan tukar reward.</div>
              </div>
              <div className="rounded-2xl bg-white/80 p-3 shadow-sm border border-emerald-100/50">
                <ShieldCheck className="mb-2 h-4 w-4 text-emerald-600" />
                <div className="font-semibold">Admin</div>
                <div className="mt-1 text-xs text-emerald-700 leading-tight">Kelola transaksi, pickup, dan dashboard.</div>
              </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    {role === 'admin' ? (
                      ...
                      <Link to="/forgot-password" title="Klik untuk mereset password" className="text-xs font-medium text-emerald-600 hover:text-emerald-700">
                        Lupa password?
                      </Link>
                    )}
                  </div>
              ...
              {role === 'admin' && (
                <div className="rounded-2xl border border-blue-100 bg-blue-50 p-4 text-sm text-blue-900 leading-relaxed italic">
