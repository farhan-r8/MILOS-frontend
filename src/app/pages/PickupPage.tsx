...
import { Calendar, Clock, Package, CheckCircle2, Info, ListChecks, HelpCircle, Truck } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-10 text-center md:text-left">
            <div className="flex flex-col items-center md:items-start md:flex-row gap-3">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Permintaan Pickup</h1>
                <p className="text-gray-500 mt-2 text-sm md:text-base">Atur waktu pengambilan sampah Anda dengan mudah.</p>
              </div>
            </div>
          </div>
